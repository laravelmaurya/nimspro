<aside class="main-sidebar  elevation-4">
  ...
  <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="#" class="d-inline-block border-bottom">@php $name = (isset(Auth::user()->nims_wp_user_name) && !empty(Auth::user()->nims_wp_user_name)) ? Auth::user()->nims_wp_user_name: 'No name'; echo ucfirst($name) @endphp </a>
            <a href="{{route('signout')}}" class="ml-1 text-danger"><i class='fas fa-power-off'></i></a>
          </div>
      </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
             ...
             <li class="nav-item">
               <a href="{{route('users.index')}}" class="nav-link">
                 <i class="nav-icon fas fa-light fa-users" style="color: #007bff;"></i>
                 <p>All Users</p>
               </a>
             </li>
             @endcan           
                 ...
                 <ul class="nav nav-treeview">
                   ...
                   <li class="nav-item">
                     <a href="javascript:void(0);"  id="morningService" class="nav-link" data-title="Morning Out Patient Services" data-cardtitle="Morning Out Patient Services" data-modalstype="Show" data-te="hospital_services" data-id="morning_service_pendingmenu" >
                       <i class="far fa-circle nav-icon"></i>
                       <p class="text-center text-truncate">Pending Morning Out &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Patient Services</p>
                     </a>
                   </li>
                   @endcan                                                  
                   @can('permission-list')
                 ...
                 <li class="nav-item">
                   ...
                   <ul class="nav nav-treeview">                                    
                     <li class="nav-item">
                         ...
                         <p>
                             Medical
                             <i class="right fas fa-angle-left angle-margin"></i>
                         </p>
                         </a>
                         {{-- LEVEL 3 --}}
                         <ul class="nav nav-treeview">
                         ...
                         <li class="nav-item">
                             ...
                             <i class="far fa-circle nav-icon"></i>
                             <p class="text-center text-truncate">Broad Speciality <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MD / MS</p>
                             </a>
                         </li> 
                         @endcan 
                         @can('permission-create')
                         ...
                         <li class="nav-item">
                             ...
                             <i class="far fa-circle nav-icon"></i>
                             <p class="text-center text-truncate">Super Speciality <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (DM/ MCh)</p>
                             </a>
                         </li> 
                         @endcan                                                                     
                         @can('permission-create')
                  ...
                  <ul class="nav nav-treeview">                                    
                   <li class="nav-item">
                       ...
                       <li class="nav-item">
                           ...
                           <i class="far fa-circle nav-icon"></i>
                           <p>Bachelor of <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Physiotherapy (BPT)</p>
                           </a>
                       </li> 
                       @endcan 
                       @can('permission-create')
                       <li class="nav-item">
                           ...
                           <i class="far fa-circle nav-icon"></i>
                           <p>Master of Physiotherapy<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(MPT)</p>
                           </a>
                       </li> 
                       @endcan                                                                                                                                                                
                       </ul>
                  ...
                  <ul class="nav nav-treeview">                                    
                   <li class="nav-item">
                       ...
                       <li class="nav-item">
                           ...
                           <i class="far fa-circle nav-icon"></i>
                           <p>Master in Hospital <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Management (MHM)</p>
                           </a>
                       </li> 
                       @endcan                                                                                                                                                                                    
                       @can('permission-create')
                         ...
                         <ul class="nav nav-treeview">
                           ...
                           <li class="nav-item">
                             <a href="javascript:void(0);"  class="editBtn2 nav-link" data-title="The Learning Center Programmes January to December" data-cardtitle="The Learning Center Programmes January to December" data-modalstype="Show" data-te="academic_ap" data-id="AP_nlcp" >
                               <i class="far fa-circle nav-icon"></i>
                               <p>NIMS Learning Center <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Programmes</p>
                             </a>
                           </li>
                           @endcan                                                  
                           @can('permission-list')
                           <li class="nav-item">
                             <a href="javascript:void(0);"  class="editBtn2 nav-link" data-title="Clinical Infectious Diseases Conference" data-cardtitle="Clinical Infectious Diseases Conference" data-modalstype="Show" data-te="academic_ap" data-id="AP_cidc" >
                               <i class="far fa-circle nav-icon"></i>
                               <p>Clinical Infectious Diseases <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Conference</p>
                             </a>
                           </li>
                           @endcan                                                  
                           @can('permission-list')
                           ...
                           <li class="nav-item">
                             <a href="javascript:void(0);"  class="editBtn2 nav-link" data-title="Morality Audit with Case Discussion" data-cardtitle="Morality Audit with Case Discussion" data-modalstype="Show" data-te="academic_ap" data-id="AP_macd" >
                               <i class="far fa-circle nav-icon"></i>
                               <p>Mortality Audit with Case <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Discussion</p>
                             </a>
                           </li>
                           @endcan                                                  
                           @can('permission-list')
