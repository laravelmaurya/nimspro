<div class="modal fade" id="create-examinations-associate-modal">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                {{-- <h4 class="modal-title">Add New Examination  </h4> --}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form id="create_form_corrigendum" class="create_form_corrigendum" role="form" method="POST"  action="{{route('examinations.stroe-corrigendum')}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Select Examination Number<span class="text-danger">*</span> </label>
                                                ...
                                                <div class="card-footer p-0 bg-white">
                                                    ...
                                                    <input value="{{ route("examinations.get-number") }}" id="get_number" type="hidden">
                                                </div>
                                                <!-- /.card body -->
                                            </div>
                                            <!-- /.form -->
