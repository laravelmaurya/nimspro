...
$(document).ready(function () {
    $('.getNumber').click(function () {
        ...
        url=url.trim();
        // alert(url);
        // Fetch recruitment numbers via AJAX
        $.ajax({
            url: url,
            type: 'GET',
            success: function(data) {
                ...
                if (data.length > 0) {
                    ...
                    $.each(data, function(index, recruitment) {                        
                        $NumberSelect.append('<option value="' + recruitment.nims_recruitment_number + '">' + recruitment.nims_recruitment_number + '</option>');
                    });
                } else {
            ...
            error: function() {
                alert('Failed to fetch recruitment numbers.');
            }
        });
    });
});
