        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form id="create_form_corrigendum" class="create_form_corrigendum" role="form" method="POST"  action="{{route('admissions.stroe-corrigendum')}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Select Admission Number<span class="text-danger">*</span> </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="exampleInputEmail1">Admission Title <span class="text-danger">*</span></label>
                ...
                <div class="modal-footer">
                    ...
                    <button id="formSubmit" type="button" class="btn btn-sm btn-primary formSubmita"><i class="fas fa-paper-plane"></i> Submit</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
