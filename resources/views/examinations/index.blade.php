...
@include('examinations.edit-modal')
...
$(document).ready(function () {
    ...
    $('body').on('click', '.editBtn', function () {
        var id = $(this).data('id');
        $.get("{{ route('examinations.index') }}" + '/' + id + '/edit', function (data) {
            ...
            // console.log('nims_examination_desc = ',data.nims_examination_desc);
...
<script>
  ...
  <script src="{{asset($addPublic.'js/customs/examinations/edit-form.js')}}"></script>
