                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <!-- form start -->
                                        <form id="create_form_corrigendum" class="create_form_corrigendum" role="form" method="POST"  action="{{route('recruitments.stroe-corrigendum')}}"  enctype="multipart/form-data">
                                            @csrf
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Select Recruitment Number<span class="text-danger">*</span> </label>
                                                ...
                                                <div class="row">                                                    
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Apply Online <span class="text-danger">*</span></label>
                                                            <select name="applyonline" id="apply_online" class="form-control @error('applyonline') is-invalid @enderror"  data-placeholder="Select a Online" style="width: 100%;">
                                                ...
                                                <div class="card-footer p-0 bg-white">
                                                    ...
                                                    <input value="{{ route("recruitments.get-number") }}" id="get_number" type="hidden">
                                                </div>
                                                <!-- /.card body -->
                                            </div>
                                            <!-- /.form -->
